...
WHERE  id = %1";
  ...
  static
  function initSet(&$form, $id, $entityTable = 'civicrm_event', $validOnly = FALSE) {
    // get price info
 ...
 */
static
function checkCurrentMembership(&$options, $userid) {
 ...
 */
static
function setDefaultPriceSet(&$form, &$defaults) {
...
static
function eventPriceSetDomainID() {
